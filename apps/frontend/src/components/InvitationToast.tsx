...
export const InvitationToast: React.FC = () => {
  ...
  return (
    <div className="fixed top-6 right-6 z-50 max-w-sm w-full animate-game-pop select-none">
      <GamePanel
        variant="gold"
      ...
      >
        <div className="flex items-start space-x-3.5">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-amber-400 to-amber-600 border-2 border-amber-300 shadow-[0_3px_0_#451a03] flex items-center justify-center shrink-0">
